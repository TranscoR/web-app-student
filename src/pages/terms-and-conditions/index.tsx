...
const Index = () => {
  return (
    <Main
      meta={
        <Meta
          title="TranscoR - Términos y Condiciones"
        ...
        <Box mb={4}>
          ...
          <Box mt={2}>
            <Text>
              ...
              secundaria tambien pagan las vacaciones. este pago es por el
              período que se trabajo aunque no regresen
            </Text>
          </Box>
        </Box>
        <Box>
          ...
          <Box mt={2}>
            <Text>
              ...
              asistente y peatones de modo que deberia permanecer sentado
              durante el trayecto
            </Text>
          </Box>
          <Box mt={2}>
            <Text>
              ...
              salido del colegio y de informar al operador o asistente si
              requiere de mas tiempo dentro de las instalaciones escolares (si
              demora mas tiempo se le dara aviso al tutor)
            </Text>
          </Box>
          <Box mt={2}>
            <Text>
          ...
          <Box mt={2}>
            <Text>
              - En caso de no encontrar a alguien en el domicilio, el tutor
              tendra la oblogacion de localizar al operador para saber donde lo
              recogera y esto causara cobro de guarderia de $100.00 pesos
            </Text>
          </Box>
        </Box>
      </Content>
